  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="text-center md:text-left">
        ...
        <p className={`text-sm ${p.textMuted} mt-1`}>All transactions via PAY.ID</p>
      </div>

      {/* Summary Cards — PIVY Style */}
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <div className="relative z-10">
            <div className="text-white/80 text-xs font-medium mb-1">Total Sent</div>
            <div className="text-2xl font-bold text-white">${totalSent.toFixed(2)}</div>
          </div>
        ...
        <motion.div
          ...
          className="rounded-xl p-5 relative overflow-hidden"
          style={{ background: 'linear-gradient(135deg, #00D084 0%, #00B86E 100%)' }}
        >
          <div className="relative z-10">
            <div className="text-white/80 text-xs font-medium mb-1">Total Received</div>
      ...
      <motion.div
        ...
        className="space-y-3"
      >
        <div className={`flex items-center gap-2 p-3 rounded-xl ${p.dark ? 'bg-white/3' : 'bg-black/3'}`}>
