...
import { useRulesConsole } from './rules-console/useRulesConsole'
...
export default function RulesConsolePage() {
  const {
    ...
    isRegistering, isConfirming, registerStage, registerHash, registerSuccess, registerError,
    ...
    direction, setDirection, version, setVersion, setRegisterStage,
    txLog, setTxLog,
